...
void init_data(pybind11::module& m)
{
  ...
  pybind11::class_<supera::Particle>(m, "Particle", DOC(supera, Particle))
      ...
      .def("end_p", &supera::Particle::end_p, DOC(supera, Particle, end_p))
      ...
      .def_readwrite("primary", &supera::Particle::primary, DOC(supera, Particle, primary))
      ...
      .def_readwrite("end_px", &supera::Particle::end_px, DOC(supera, Particle, end_px))
      .def_readwrite("end_py", &supera::Particle::end_py, DOC(supera, Particle, end_py))
      .def_readwrite("end_pz", &supera::Particle::end_pz, DOC(supera, Particle, end_pz))
  ...
  pybind11::class_<supera::Neutrino>(m, "Neutrino", DOC(supera, Neutrino))
      ...
      .def_readwrite("interaction_id", &supera::Neutrino::interaction_id, DOC(supera, Neutrino, interaction_id))
      .def_readwrite("nu_track_id", &supera::Neutrino::nu_track_id, DOC(supera, Neutrino, nu_track_id))
  ...
  pybind11::class_<supera::Flash>(m, "Flash", DOC(supera, Flash))
      ...
      .def_readwrite("timeWidth", &supera::Flash::timeWidth, DOC(supera, Flash, timeWidth))
      .def_readwrite("frame", &supera::Flash::frame, DOC(supera, Flash, frame))
      .def_readwrite("PEPerOpDet", &supera::Flash::PEPerOpDet, DOC(supera, Flash, PEPerOpDet))
      .def_readwrite("wireCenters", &supera::Flash::wireCenters, DOC(supera, Flash, wireCenters))
      .def_readwrite("wireWidths", &supera::Flash::wireWidths, DOC(supera, Flash, wireWidths))
      .def_readwrite("xCenter", &supera::Flash::xCenter, DOC(supera, Flash, xCenter))
      .def_readwrite("xWidth", &supera::Flash::xWidth, DOC(supera, Flash, xWidth))
      .def_readwrite("yCenter", &supera::Flash::yCenter, DOC(supera, Flash, yCenter))
      .def_readwrite("yWidth", &supera::Flash::yWidth, DOC(supera, Flash, yWidth))
      .def_readwrite("zCenter", &supera::Flash::zCenter, DOC(supera, Flash, zCenter))
      .def_readwrite("zWidth", &supera::Flash::zWidth, DOC(supera, Flash, zWidth))
