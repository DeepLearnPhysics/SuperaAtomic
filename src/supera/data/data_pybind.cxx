...
void init_data(pybind11::module& m)
{
  ...
  // classes from Particle.h
   ...
   .def_readwrite("gen_id", &supera::Particle::gen_id, DOC(supera, Particle, trackid))
   ...
   .def_readwrite("px_end", &supera::Particle:px_end, DOC(supera, Particle, px_end))
   .def_readwrite("py_end", &supera::Particle:py_end, DOC(supera, Particle, py_end))
   .def_readwrite("pz_end", &supera::Particle:pz_end, DOC(supera, Particle, pz_end))
