...
void init_data(pybind11::module& m)
{
  ...
  pybind11::class_<supera::Neutrino>(m, "Neutrino", DOC(supera, Neutrino))
      ...
      .def("p_lep", &supera::Neutrino::p_lep, DOC(supera, Neutrino, p_lep))
      .def_readwrite("id", &supera::Neutrino::id, DOC(supera, Neutrino, id))
      .def_readwrite("event_id", &supera::Neutrino::event_id, DOC(supera, Neutrino, event_id))
      ...
      .def_readwrite("pdg_code_lep", &supera::Neutrino::pdg_code_lep, DOC(supera, Neutrino, pdg_code_lep))
      ...
      .def_readwrite("px_lep", &supera::Neutrino::px_lep, DOC(supera, Neutrino, px_lep))
      .def_readwrite("py_lep", &supera::Neutrino::py_lep, DOC(supera, Neutrino, py_lep))
      .def_readwrite("pz_lep", &supera::Neutrino::pz_lep, DOC(supera, Neutrino, pz_lep))
